...
import { DetalleCorporativosComponent } from './detalle-corporativos/detalle-corporativos.component';
...
@NgModule({
  declarations: [AppComponent, FullLayoutComponent, ContentLayoutComponent, CorporativosComponent, DetalleCorporativosComponent],
  imports: [
